---
description: Prompt Nano Banana Pro
---
...
## Bước 7: Tạo File .txt (khi viết nhiều prompts)

Khi hoàn thành viết danh sách nhiều prompts (ví dụ: cho bộ ảnh, series):

// turbo
1. Tạo file `.txt` chỉ chứa **số thứ tự** và **prompt** (không tiêu đề, không giải thích)
2. Format: `1. [prompt]` - mỗi prompt trên một dòng
3. Lưu cùng thư mục với file gốc, thêm đuôi `.txt`

**Ví dụ output:**
```
1. Nostalgic Vietnamese watercolor illustration in 16:9 aspect ratio, [scene description]...
2. Nostalgic Vietnamese watercolor illustration in 16:9 aspect ratio, [scene description]...
```

**Lưu ý bố cục xen kẽ:**
- Khi tạo nhiều ảnh trong cùng bộ, xen kẽ vị trí khoảng trống (trái/phải) để tránh nhàm chán
- Số lẻ (1, 3, 5...): Khoảng trống bên **trái**
- Số chẵn (2, 4, 6...): Khoảng trống bên **phải**
