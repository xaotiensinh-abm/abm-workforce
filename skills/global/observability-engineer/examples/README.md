# Examples - observability-engineer
...
```
# Example: typical observability-engineer invocation
...
```
# Example: edge case for observability-engineer
...
```
# Anti-pattern: incorrect usage of observability-engineer
