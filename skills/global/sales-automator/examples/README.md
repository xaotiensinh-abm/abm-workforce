...
```
# Example: typical sales-automator invocation
...
```
# Example: edge case for sales-automator
...
```
# Anti-pattern: incorrect usage of sales-automator
