...
```
# Example: typical kpi-dashboard-design invocation
...
```
# Example: edge case for kpi-dashboard-design
...
```
# Anti-pattern: incorrect usage of kpi-dashboard-design
