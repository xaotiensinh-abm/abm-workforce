# Examples - mep-tender-automation
...
```
# Example: typical mep-tender-automation invocation
...
```
# Example: edge case for mep-tender-automation
...
```
# Anti-pattern: incorrect usage of mep-tender-automation
