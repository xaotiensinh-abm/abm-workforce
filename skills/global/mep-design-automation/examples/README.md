# Examples - mep-design-automation
...
```
# Example: typical mep-design-automation invocation
...
```
# Example: edge case for mep-design-automation
...
```
# Anti-pattern: incorrect usage of mep-design-automation
