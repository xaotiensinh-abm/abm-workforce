# Examples - competitive-landscape
...
```
# Example: typical competitive-landscape invocation
...
```
# Example: edge case for competitive-landscape
...
```
# Anti-pattern: incorrect usage of competitive-landscape
