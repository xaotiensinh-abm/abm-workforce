...
```
# Example: typical web-image-generator invocation
...
```
# Example: edge case for web-image-generator
...
```
# Anti-pattern: incorrect usage of web-image-generator
