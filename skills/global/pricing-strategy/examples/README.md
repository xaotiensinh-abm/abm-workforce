...
```
# Example: typical pricing-strategy invocation
...
```
# Example: edge case for pricing-strategy
...
```
# Anti-pattern: incorrect usage of pricing-strategy
