# Examples - abm-multi-persona-review
...
```
# Example: typical abm-multi-persona-review invocation
...
```
# Example: edge case for abm-multi-persona-review
...
```
# Anti-pattern: incorrect usage of abm-multi-persona-review
