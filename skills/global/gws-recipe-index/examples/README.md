...
```
# Example: typical gws-recipe-index invocation
...
```
# Example: edge case for gws-recipe-index
...
```
# Anti-pattern: incorrect usage of gws-recipe-index
