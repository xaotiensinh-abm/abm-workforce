# Examples - multi-agent-brainstorming
...
```
# Example: typical multi-agent-brainstorming invocation
...
```
# Example: edge case for multi-agent-brainstorming
...
```
# Anti-pattern: incorrect usage of multi-agent-brainstorming
