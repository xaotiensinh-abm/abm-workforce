...
Examples:
  ...
  # Use Gemini 3 Pro for enhanced analysis
  %(prog)s --input document.pdf --model gemini-3-pro-preview
...
Default output: <project-root>/docs/assets/document-extraction.md
    ...
    parser.add_argument('--auto-name', '-a', action='store_true',
                       help='Auto-generate meaningful output filename from input')
    parser.add_argument('--model', default='gemini-2.5-flash',
                       help='Gemini model to use (default: gemini-2.5-flash). '
                            'Options: gemini-3-pro-preview, gemini-2.5-flash, gemini-2.5-pro')
