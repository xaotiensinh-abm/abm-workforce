...
```
# Example: typical jarvis-orchestrator invocation
...
```
# Example: edge case for jarvis-orchestrator
...
```
# Anti-pattern: incorrect usage of jarvis-orchestrator
