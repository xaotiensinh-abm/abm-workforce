# Examples - docx-document-builder
...
```
# Example: typical docx-document-builder invocation
...
```
# Example: edge case for docx-document-builder
...
```
# Anti-pattern: incorrect usage of docx-document-builder
