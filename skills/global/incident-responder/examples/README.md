...
```
# Example: typical incident-responder invocation
...
```
# Example: edge case for incident-responder
...
```
# Anti-pattern: incorrect usage of incident-responder
