...
```
# Example: typical executing-plans invocation
...
```
# Example: edge case for executing-plans
...
```
# Anti-pattern: incorrect usage of executing-plans
