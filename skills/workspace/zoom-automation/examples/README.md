...
```
# Example: typical zoom-automation invocation
...
```
# Example: edge case for zoom-automation
...
```
# Anti-pattern: incorrect usage of zoom-automation
