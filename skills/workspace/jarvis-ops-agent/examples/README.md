...
```
# Example: typical jarvis-ops-agent invocation
...
```
# Example: edge case for jarvis-ops-agent
...
```
# Anti-pattern: incorrect usage of jarvis-ops-agent
