...
```
# Example: typical ai-agents-architect invocation
...
```
# Example: edge case for ai-agents-architect
...
```
# Anti-pattern: incorrect usage of ai-agents-architect
