...
```
# Example: typical error-handling-patterns invocation
...
```
# Example: edge case for error-handling-patterns
...
```
# Anti-pattern: incorrect usage of error-handling-patterns
