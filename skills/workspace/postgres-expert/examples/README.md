...
```
# Example: typical postgres-expert invocation
...
```
# Example: edge case for postgres-expert
...
```
# Anti-pattern: incorrect usage of postgres-expert
