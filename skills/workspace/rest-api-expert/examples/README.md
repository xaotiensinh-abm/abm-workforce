...
```
# Example: typical rest-api-expert invocation
...
```
# Example: edge case for rest-api-expert
...
```
# Anti-pattern: incorrect usage of rest-api-expert
