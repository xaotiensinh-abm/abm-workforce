# Examples - jarvis-optimizer-agent
...
```
# Example: typical jarvis-optimizer-agent invocation
...
```
# Example: edge case for jarvis-optimizer-agent
...
```
# Anti-pattern: incorrect usage of jarvis-optimizer-agent
