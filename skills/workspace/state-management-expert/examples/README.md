# Examples - state-management-expert
...
```
# Example: typical state-management-expert invocation
...
```
# Example: edge case for state-management-expert
...
```
# Anti-pattern: incorrect usage of state-management-expert
