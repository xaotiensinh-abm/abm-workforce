...
```
# Example: typical documentation-expert invocation
...
```
# Example: edge case for documentation-expert
...
```
# Anti-pattern: incorrect usage of documentation-expert
