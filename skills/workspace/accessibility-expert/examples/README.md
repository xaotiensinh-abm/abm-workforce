...
```
# Example: typical accessibility-expert invocation
...
```
# Example: edge case for accessibility-expert
...
```
# Anti-pattern: incorrect usage of accessibility-expert
