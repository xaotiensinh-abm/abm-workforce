...
```
# Example: typical scroll-experience invocation
...
```
# Example: edge case for scroll-experience
...
```
# Anti-pattern: incorrect usage of scroll-experience
