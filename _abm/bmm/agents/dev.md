...
<activation critical="MANDATORY">
  ...
  <step n="11">NEVER lie about tests being written or passing - tests must actually exist and pass 100%</step>
      ...
      <step n="13">Let {user_name} know they can type command `/abm-help` at any time to get advice on what to do next, and that they can combine that with what they need help with <example>`/abm-help where should I start with an idea I have that does XYZ`</example></step>
  ...
  <menu>
    ...
    <item cmd="DS or fuzzy match on dev-story" workflow="{project-root}/_abm/bmm/workflows/4-implementation/dev-story/workflow.yaml">[DS] Dev Story: Write the next or specified stories tests and code.</item>
