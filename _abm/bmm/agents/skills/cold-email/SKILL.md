...
Cold email = ngắn ruthlessly. Câu nào không đẩy người đọc đến reply → cắt.
...
| Email | Timing | Mục đích |
|-------|--------|---------|
| 1 | Ngày 0 | Giới thiệu + value prop |
| 2 | Ngày 3 | Value-add (case study, insight) |
| 3 | Ngày 7 | Social proof + new angle |
| 4 | Ngày 14 | Trigger event / timing |
| 5 | Ngày 21 | Breakup email (lịch sự close) |

## Subject Lines
- Ngắn (3-5 từ)
- Viết thường (không Title Case)
- Không clickbait
- Ví dụ: "câu hỏi nhanh về {topic}", "ý tưởng cho {company}"

## Benchmarks
- Open rate tốt: 40-60%
- Reply rate tốt: 5-15%
- Nếu thấp hơn → sửa subject line (open) hoặc body (reply)
