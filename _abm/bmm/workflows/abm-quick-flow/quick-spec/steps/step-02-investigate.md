...
- IF C: Verify frontmatter updated with `stepsCompleted: [1, 2]`, then read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-spec/steps/step-03-generate.md`
