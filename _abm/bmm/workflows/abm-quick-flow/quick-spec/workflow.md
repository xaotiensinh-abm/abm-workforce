...
main_config: '{project-root}/_abm/bmm/config.yaml'
...
quick_dev_workflow: '{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev/workflow.md'
---
...
Read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.
