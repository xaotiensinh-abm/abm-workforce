...
adversarial_review_task: '{project-root}/_abm/core/tasks/review-adversarial-general.xml'
---
...
- `installed_path` = `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev-new-preview`
