...
```xml
<invoke-task>Review {diff_output} using {project-root}/_abm/core/tasks/review-adversarial-general.xml</invoke-task>
```
...
With findings in hand, read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev/steps/step-06-resolve-findings.md` for user to choose resolution approach.
