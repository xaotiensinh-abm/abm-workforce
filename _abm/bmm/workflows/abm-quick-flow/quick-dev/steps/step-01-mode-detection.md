...
- **NEXT:** Read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev/steps/step-03-execute.md`
...
- IF E: Ask for any additional guidance, then **NEXT:** Read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
- IF E: Ask for guidance, then **NEXT:** Read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
**[W] Start ABM METHOD** (recommended)
...
- Mode A (tech-spec): "**NEXT:** read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev/steps/step-03-execute.md`"
- Mode B (direct, [E] selected): "**NEXT:** Read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev/steps/step-02-context-gathering.md`"
