...
When ALL tasks are complete (or halted on blocker), read fully and follow: `{project-root}/_abm/bmm/workflows/abm-quick-flow/quick-dev/steps/step-04-self-check.md`.
