...
- Load: `{project-root}/_abm/bmm/workflows/1-analysis/research/domain-steps/step-05-technical-trends.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_abm/bmm/workflows/1-analysis/research/domain-steps/step-05-technical-trends.md` to analyze technical trends and innovations in the domain.
