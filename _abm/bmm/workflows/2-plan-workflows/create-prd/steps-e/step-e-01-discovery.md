...
prdPurpose: '{project-root}/_abm/bmm/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'
...
- **ABM variant:** 3-4 core sections present, generally follows BMAD patterns
