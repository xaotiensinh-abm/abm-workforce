...
# File References
nextStepFile: '{project-root}/_abm/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-07-project-type.md'
outputFile: '{planning_artifacts}/prd.md'

# Data Files
projectTypesCSV: '{project-root}/_abm/bmm/workflows/2-plan-workflows/create-prd/data/project-types.csv'
