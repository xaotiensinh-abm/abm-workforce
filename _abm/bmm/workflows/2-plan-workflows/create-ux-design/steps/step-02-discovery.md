...
- Load `{project-root}/_abm/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-03-core-experience.md`

## APPEND TO DOCUMENT:

When user selects 'C', append the content directly to the document. Only after the content is saved to document, read fully and follow: `{project-root}/_abm/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-03-core-experience.md`.
