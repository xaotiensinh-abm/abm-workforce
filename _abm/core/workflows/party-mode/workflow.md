...
Load config from `{project-root}/_abm/core/config.yaml` and resolve:

- `project_name`, `output_folder`, `user_name`
- `communication_language`, `document_output_language`, `user_skill_level`
- `date` as a system-generated value
- Agent manifest path: `{project-root}/_abm/_config/agent-manifest.csv`

### Paths

- `installed_path` = `{project-root}/_abm/core/workflows/party-mode`
- `agent_manifest_path` = `{project-root}/_abm/_config/agent-manifest.csv`
...
- If discussion becomes circular, have abm-master summarize and redirect
