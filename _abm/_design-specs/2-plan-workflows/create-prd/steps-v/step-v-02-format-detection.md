...
Detect if PRD follows BMAD format and route appropriately - classify as BMAD Standard / ABM variant / Non-Standard, with optional parity check for non-standard formats.
...
**Format Classification:** [BMAD Standard / ABM variant / Non-Standard]
**Core Sections Present:** [count]/6
```

### 5. Route Based on Format Classification

**IF format is BMAD Standard or ABM variant:**
