...
# File References
nextStepFile: '{project-root}/_abm/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-12-complete.md'
outputFile: '{planning_artifacts}/prd.md'
purposeFile: '{project-root}/_abm/bmm/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'

# Task References
advancedElicitationTask: '{project-root}/_abm/core/workflows/advanced-elicitation/workflow.md'
partyModeWorkflow: '{project-root}/_abm/core/workflows/party-mode/workflow.md'
---
...
After user selects 'C' and polished document is saved, load `{project-root}/_abm/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-12-complete.md` to complete the workflow.
