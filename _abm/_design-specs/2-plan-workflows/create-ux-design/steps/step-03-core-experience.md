...
- Read fully and follow: {project-root}/_abm/core/workflows/advanced-elicitation/workflow.md with the current core experience content
...
- Read fully and follow: {project-root}/_abm/core/workflows/party-mode/workflow.md with the current core experience definition
...
- Load `{project-root}/_abm/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_abm/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md` to define desired emotional responses.
