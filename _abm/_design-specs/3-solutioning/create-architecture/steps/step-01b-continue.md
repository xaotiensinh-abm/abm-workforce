...
- Example: If `stepsCompleted: [1, 2, 3]`, load `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
- If confirmed: Delete existing document and read fully and follow: `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-01-init.md`
...
- `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-02-context.md`
- `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md`
- `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
- `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-05-patterns.md`
- `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md`
- `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`
- `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-08-complete.md`
