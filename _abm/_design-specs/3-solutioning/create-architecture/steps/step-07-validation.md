...
- Read fully and follow: {project-root}/_abm/core/workflows/advanced-elicitation/workflow.md with validation issues
...
- Read fully and follow: {project-root}/_abm/core/workflows/party-mode/workflow.md with validation context
...
- Load `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-08-complete.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-08-complete.md` to complete the workflow and provide implementation guidance.
