...
- Read fully and follow: {project-root}/_abm/core/workflows/advanced-elicitation/workflow.md with the current context analysis
...
- Read fully and follow: {project-root}/_abm/core/workflows/party-mode/workflow.md with the current project context
...
- Load `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_abm/bmm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md` to evaluate starter template options.
