...
# File References
nextStepFile: '{project-root}/_abm/bmm/workflows/1-analysis/create-product-brief/steps/step-02-vision.md'
...
- **STOP immediately** and load `{project-root}/_abm/bmm/workflows/1-analysis/create-product-brief/steps/step-01b-continue.md`
