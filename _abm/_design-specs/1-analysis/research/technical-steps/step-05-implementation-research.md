...
- Load: `{project-root}/_abm/bmm/workflows/1-analysis/research/technical-steps/step-06-research-synthesis.md`
...
After user selects 'C', load `{project-root}/_abm/bmm/workflows/1-analysis/research/technical-steps/step-06-research-synthesis.md` to produce the comprehensive technical research document with narrative introduction, detailed TOC, and executive summary.
