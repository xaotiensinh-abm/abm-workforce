...
- Load: `{project-root}/_abm/bmm/workflows/1-analysis/research/domain-steps/step-04-regulatory-focus.md`
...
After user selects 'C', load `{project-root}/_abm/bmm/workflows/1-analysis/research/domain-steps/step-04-regulatory-focus.md` to analyze regulatory requirements, compliance frameworks, and legal considerations for {{research_topic}}.
