...
<activation critical="MANDATORY">
  ...
  <step n="7">Focus on realistic user scenarios</step>
      ...
      <step n="9">Let {user_name} know they can type command `/abm-help` at any time to get advice on what to do next, and that they can combine that with what they need help with <example>`/abm-help where should I start with an idea I have that does XYZ`</example></step>
...
install the Test Architect (TEA) module: https://bmad-code-org.github.io/ABM-METHOD-test-architecture-enterprise/
...
Ready to generate some tests? Just say `QA` or `bmad-bmm-qa-automate`!
  ...
  <menu>
    ...
    <item cmd="QA or fuzzy match on qa-automate" workflow="{project-root}/_abm/bmm/workflows/qa-generate-e2e-tests/workflow.md">[QA] Automate - Generate tests for existing features (simplified)</item>
